...
import { RiHeart2Fill, RiPlayCircleFill, RiPlayFill, RiRepeat2Line, RiShuffleFill, RiShuffleLine, RiSkipBackFill, RiSkipForwardFill, RiSpeaker2Fill, RiSpeaker2Line } from 'react-icons/ri'

const Player = () => {
  return (
    <div className='bg-white w-full h-20 flex items-center rounded-t-xl px-8'>
      <div className='flex w-full items-center'>
        <img src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZmlsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" className='object-cover w-12 h-12 rounded' alt="" />

        <span className='mx-4 font-bold text-lg'>Nothing is playing</span>
        ...
        <div className='w-7/12 mx-4 ml-6'>
          <input type="range" name="" className='w-full' />
        </div>
        <div className='flex text-lg text-slate-400 items-center'>
