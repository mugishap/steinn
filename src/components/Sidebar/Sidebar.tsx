        ...
        <div className='mt-6 flex w-full flex-col'>
          {
            links.map((link, index) => (
              <Link key={index} to={link.path}>
                <div onClick={() => setActive(link.label)} className={`${active === link.label ? "bg-gradient-to-r":""} my-1 cursor-pointer hover:bg-gradient-to-r py-3 w-full flex items-center justify-start px-4 from-white/40 via-white/20 to-white/10`}>
                  <link.icon size={28} />
